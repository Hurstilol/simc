...
void windwalker( player_t *p )
{
  ...
  auto _WW_ON_USE = []( const item_t &item ) {
    ...
    const static std::unordered_map<std::string, std::string> sef_trinkets{
        ...
        { "treacherous_transmitter", "cooldown.invoke_xuen_the_white_tiger.remains<4|talent.xuens_bond&(pet.xuen_the_white_tiger.active|cooldown.invoke_xuen_the_white_tiger.remains<4)" },
